document.addEventListener('DOMContentLoaded', function() {
    ...
    function showError(message, element = errorMessage) {
        // Показываем сообщение в стандартном элементе ошибки (для поддержки обратной совместимости)
        if (element) {
            element.textContent = message;
            element.classList.add('show');
        }
        
        // Также показываем всплывающее уведомление об ошибке
    ...
    function handleFirstStep(e) {
        ...
        // Проверка пароля на соответствие требованиям (минимум 3 из 5)
        ...
        // Проверяем, что выполнено минимум 3 требования
        if (metRequirements < 3) {
            showError('Пароль должен соответствовать минимум 3 требованиям безопасности');
            return false;
        }
    ...
    function setupPasswordValidation() {
        ...
        if (passwordInput && (strengthBar || requirements)) {
            ...
            function validatePassword(password) {
                ...
                // Разрешаем регистрацию, если выполнено минимум 3 требования
